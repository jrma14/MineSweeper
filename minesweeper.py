            ...
            if event.button == 1:
                ...
                if center[0] - buttonWidth / 2 <= pos[0] <= center[0] + buttonWidth / 2:
                    if center[1] - buttonHeight / 2 - (buttonHeight + distBetweenButtons) <= pos[1] \
                        ...
                        difficulty = 'easy'
                        gridSize = (width / difficultySettings[difficulty][0], height / difficultySettings[difficulty][1])
                        settings = False
                        break
            ...
            if event.button == 1:
                ...
                if center[0] - buttonWidth / 2 <= pos[0] <= center[0] + buttonWidth / 2:
                    if center[1] - buttonHeight / 2 - (buttonHeight + distBetweenButtons) <= pos[1] \
                        ...
                        board.randomizeBoard(difficultySettings[difficulty][0], difficultySettings[difficulty][1], difficultySettings[difficulty][2])
                        running = True
